...
<div id="_desktop_language_selector">
  <div class="language-selector-wrapper">
    ...
    <div class="language-selector dropdown js-dropdown">
      <button data-toggle="dropdown" class="hidden-sm-down btn btn-primary" aria-haspopup="true" aria-expanded="false" aria-label="{l s='Language dropdown' d='Shop.Theme.Global'}"style=" padding: 0">
        <span class="expand-more">
            <img src="{$urls.img_lang_url}{$current_language.id_lang}.jpg" />
        </span>
      </button>
      ...
      <select class="link hidden-md-up" aria-labelledby="language-selector-label">
        ...
        <div class="pro-only">
            {if $language.iso_code =="fr"}Réservé aux professionnels
            {elseif $language.iso_code =="en"}For professionals only
            {/if}
        </div>
    </div>
  </div>
